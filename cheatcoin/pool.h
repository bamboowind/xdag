...
/* initializing the pool (pool_on = 1) or connecting the miner to the pool (pool_on = 0; pool_arg - pool parameters ip: port [: CFG];
    miner_addr - the address of the miner, if it is specified explicitly */
